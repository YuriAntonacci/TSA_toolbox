function [A,Su,phi_w]=RLS_ID_AR1_IC(Y,p,c,Ai,Sui)
...
% Ai --> initial condition for AR parameters
% Sui--> initial condition for innovation variance
% output:
