%% Test Simulation1
% Time-specific information storage with an AR coeffient varying as a
% periodic square waveform (scenario 1 - Fig.1a main document)
close all;clear all;clc
%% generation of time variant AR coefficient
rng(1,'twister')
...
r = 0.8;                            % value of innovation variance
A_T(1,p,:)=c+cmax*2;             % theoretical AR vector
Su_T(1,1,:) = repmat(r,1,1,length(c)); % theoretical innovation variance set to r                
% Data generation
